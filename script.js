...
const peopleData = [
    ...
    { name: "Novan", password: "jogetduludong", clue: "Sepatuku biasanya PUTIH" },
    ...
    { name: "Salsa", password: "mautauaja", clue: "Namaku ada di judul Film" },
    ...
    { name: "Alvin", password: "password", clue: "Emma kecil" },
    { name: "Slash", password: "Labalabasunda", clue: "Aku gak pake kacamata" },
    { name: "Yongki", password: "sembarang", clue: "HP ku POCO" },
    { name: "Vara", password: "kaefsi", clue: "Aku suka makan Indomie Kari Ayam" },
    { name: "Jesslyn", password: "terserah", clue: "Rambutku belah tengah'" },
    { name: "Rizky", password: "beraksekebon", clue: "Aku suka pake celana hitam" },
    { name: "Issa", password: "rahasia", clue: "Aku gak pake gelang" },
    { name: "Paul", password: "12345", clue: "Aku gak berkumis" },
    { name: "Eric", password: "mienyemek", clue: "Kalo ngomong cepet" },
    { name: "Trixie", password: "sama kyk jesi", clue: "Aku kaya introvert" },
    { name: "Grace", password: "cobamelet", clue: "Aku jomblo" },
